...
test('check if the ship has placed successfully',() => {
    ...
    expect(boardTest1.ships.carrier).toEqual([[4, 5], [4, 6], [4, 7], [4, 8], [4, 9]]);
    expect(boardTest1.placeShip(boardTest1.playerShip.battleship, [4, 5], 'v')).toBe(false);
})
...
test('check if the ship has placed successfully',() => {
    ...
    expect(boardTest1.ships.submarine).toEqual([[4, 5], [5, 5], [6, 5]])
})
...
test('check if the ship has placed successfully',() => {
    ...
    expect(boardTest1.ships.destroyer).toEqual([[9, 5], [9, 6], [9, 7]])
})
...
test('check if the ship has placed successfully',() => {
    ...
    expect(boardTest1.ships.patrol).toEqual([[2, 8], [3, 8]])   
...
test('check if the ship has placed successfully',() => {
    ...
    expect(boardTest1.ships.battleship).toEqual([[7, 5], [7, 6], [7, 7], [7, 8]])
})
...
test('check if the hit signal is working', () => {
    ...
    board1.receiveAttack([9, 6]);
    board1.receiveAttack([9, 7]);
